...
```sh
npm install tailwindcss-mainanimation
```
...
/* tailwind css v4.x */
@import "tailwindcss";
@import "tailwindcss-mainanimation";
```
...
module.exports = {
  // ...
  plugins: [
    require('tailwindcss-mainanimation')
  ],
}
```
...
https://tailwindcss-mainanimation.com/configurator.html
...
<a href="https://www.npmjs.com/package/tailwindcss-mainanimation"><img src="https://img.shields.io/npm/dt/tailwindcss-mainanimation?style=for-the-badge"></a>
